...
export default function Row_WorkColumn({title, description, imagepath, videokey, child_changevideo}:{title:string, description:string, imagepath:string, videokey:string, child_changevideo:Function}){
        return(
