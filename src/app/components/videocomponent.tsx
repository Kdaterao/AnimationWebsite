...
function Videoplayer({src, videos, handleMouseDown_video}:{src:string, videos:video_type[], handleMouseDown_video:Function}){
       ...
       const [currenttitle, changetitle] = useState<string>('idk what the title is yet')
       ...
       useEffect(() => {
        ...
        return (
            <div className = 'h-100 md:h-150 lg:h-200 w-screen max-w-350 flex flex-col  bg-[var(--color-variableblue)] rounded-4xl self-center hover:-translate-y-2 shadow-2xl' >
                <div className = 'flex flex-row h-7 md:h-11 lg:h-17 w-full rounded-t-4xl bg-[var(--color-variablebluedark)]' onMouseDown ={() => handleMouseDown_video()}>
                ...
                <div className ='bg-[var(--color-variablepurple)] h-7 md:h-11 lg:h-17 rounded-tr-2xl ' onMouseDown ={() => handleMouseDown_video()}/>
                    ...
                    <div className='w-10'></div>
                        <div className ='grid grid-cols-6 grid-rows-5 gap-13 sm:gap-13 md:gap-3'>
                            <div className ='col-start-2 row-start-1 col-span-4 row-span-1 md:col-start-1 md:col-span-4 md:row-span-full lg:col-span-4'>
                                <video ref={ref} src={currentvideo} muted loop playsInline className = 'brightness-80 object-scale-down rounded-2xl'/>
                                <h3 className='invisible md:visible md:text-7xl'>{currenttitle}</h3>
                            </div>
