...
function EmailForm({handlemouseformdown,Windowbuttonfunction}:{handlemouseformdown:() => void,Windowbuttonfunction:(divname:string, from:string) => void}){
    ...
    return (
        <div  className= 'w-95 md:w-100 2md:w-125 lg:w-150 2lg:w-175 rounded-sm pb-3 bg-[var(--color-variableblue)] self-center flex flex-col transition duration-75 hover:translate-y-2 shadow-2xl outline-2 outline-[var(--color-outline)]' onMouseDown = {() => handlemouseformdown}>
