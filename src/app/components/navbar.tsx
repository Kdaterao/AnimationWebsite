    ...
    <div className='flex flex-row  backgrounddark:opacity-80'>
        <div className ='h-3 flex flex-col justify-center-safe '>
            ...
            <div className = ' flex flew-row gap-5 z-3'>
                    <div className ='w-0 xsm:w-10 md:w-20 lg:w-40 invisible backgrounddark:visible mt-4 backgrounddark:mt-1 outline-2 outline-[var(--color-outline) rounded-sm'>
                    ...
                    <div className ='w-0 xsm:min-w-screen invisible backgrounddark:visible mt-4 backgrounddark:mt-1 outline-2 outline-[var(--color-outline) rounded-sm'>
                        <div className='h-10 w-full  bg-[var(--color-navbar)]'></div>
                    </div>
            </div>
