...
function Tabbar ({handlemousedown, message}:{handlemousedown:() => void, message:string}) {
    ...
    return(
            <div>
                <div className = 'flex flex-row h-7 sm:h-9 md:h-11 lg:h-12 2lg:h-14 xl:h-17 w-full rounded-t-4xl bg-[var(--color-variablebluedark)] select-none' onMouseDown ={() => handlemousedown()}>
